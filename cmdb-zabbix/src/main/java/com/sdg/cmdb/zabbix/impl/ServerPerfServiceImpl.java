...
public class ServerPerfServiceImpl implements ServerPerfService, InitializingBean {
    ...
    public void invokePerf(ServerPerfVO serverPerfVO, ServerDO serverDO) {
        ...
        try {
            ...
            BigDecimal bigDecimal = new BigDecimal(Float.valueOf(cpuIowait));
        ...
        try {
            ...
            if (StringUtils.isEmpty(load1)) {
                serverPerfVO.setLoad1("-1");
            } else {
                BigDecimal bigDecimal1 = new BigDecimal(Float.valueOf(load1));
            ...
            if (StringUtils.isEmpty(load5)) {
                serverPerfVO.setLoad5("-1");
            } else {
                BigDecimal bigDecimal5 = new BigDecimal(Float.valueOf(load5));
            ...
            if (StringUtils.isEmpty(load15)) {
                serverPerfVO.setLoad15("-1");
            } else {
                BigDecimal bigDecimal15 = new BigDecimal(Float.valueOf(load15));

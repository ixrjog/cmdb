...
//            System.err.println(g);
    ...
    public void testGetMailUserAccountStatus() {
        UserDO userDO = new UserDO();
        userDO.setMail("liubingling@51xianqu.net");
        authService.setMailUserAccountStatus(userDO, AuthServiceImpl.MAIL_ACCOUNT_STATUS_CLOSED);
        System.err.println(authService.getMailAccountStatus("liubingling@51xianqu.net"));
    }

    @Test
    public void testUserLeaving() {
        //职员离职通知: {  姓名: 郑衍,   工号: 002864,   手机号: 15167124335,   职务: 服务体验专员,   部门: 总裁办-服务体验部,   工作城市: 杭州,
        // 工作邮箱: zhengyan@51xianqu.net }

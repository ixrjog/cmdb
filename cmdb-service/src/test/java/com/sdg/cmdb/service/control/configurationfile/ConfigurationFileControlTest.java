...
public class ConfigurationFileControlTest {
    ...
    public void testAnsibleHostService() {
        //// TODO ansible 只分2组列表
        String result =  ansibleHostService.acqConfig(0);
        System.err.println(result);
    }
    ...
    public void testAnsibleHostService2() {
        //// TODO ansible 全局列表
         String result =  ansibleHostService.acqConfig(2);
         System.err.println(result);
    }
    ...
    public void testInterfaceCIService() {
        //// TODO 持续集成接口
        String result = interfaceCIService.acqConfig(0);
        System.err.println(result);
    }
    ...
    public void testGetwayService() {
        //// TODO getway全局列表
        String result = getwayService.acqConfig();
        System.err.println(result);
    }
